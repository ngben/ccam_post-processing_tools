...
# Base directory for daily files
### ACCESS-CM2
#base_dir="/scratch/e53/bxn599/axiom_20i/CORDEX-CMIP6/DD/AUS-20i/CSIRO/ACCESS-CM2/ssp370/r4i1p1f1/CCAM-v2203-SN/v1-r1"
#backup_base_dir="/scratch/xv83/bxn599/backup_aus-20i_daily_monthly_separated_by_year/access-cm2_ssp370"
### ACCESS-ESM1-5
#base_dir="/scratch/e53/bxn599/axiom_20i/CORDEX-CMIP6/DD/AUS-20i/CSIRO/ACCESS-ESM1-5/ssp370/r6i1p1f1/CCAM-v2203-SN/v1-r1"
#backup_base_dir="/scratch/xv83/bxn599/backup_aus-20i_daily_monthly_separated_by_year/access-esm1-5_ssp370"
### CESM2
base_dir="/scratch/e53/bxn599/axiom_20i/CORDEX-CMIP6/DD/AUS-20i/CSIRO/CESM2/ssp370/r11i1p1f1/CCAM-v2203-SN/v1-r1"
backup_base_dir="/scratch/xv83/bxn599/backup_aus-20i_daily_monthly_separated_by_year/cesm2_ssp370"
### CMCC-ESM2
#base_dir="/scratch/e53/bxn599/axiom_20i/CORDEX-CMIP6/DD/AUS-20i/CSIRO/CMCC-ESM2/ssp370/r1i1p1f1/CCAM-v2203-SN/v1-r1"
#backup_base_dir="/scratch/xv83/bxn599/backup_aus-20i_daily_monthly_separated_by_year/cmcc-esm2_ssp370"
### CNRM-ESM2-1
#base_dir="/scratch/e53/bxn599/axiom_20i/CORDEX-CMIP6/DD/AUS-20i/CSIRO/CNRM-ESM2-1/ssp370/r1i1p1f2/CCAM-v2203-SN/v1-r1"
#backup_base_dir="/scratch/xv83/bxn599/backup_aus-20i_daily_monthly_separated_by_year/cnrm-esm2-1_ssp370"
### EC-Earth3
#base_dir="/scratch/e53/bxn599/axiom_20i/CORDEX-CMIP6/DD/AUS-20i/CSIRO/EC-Earth3/ssp370/r1i1p1f1/CCAM-v2203-SN/v1-r1"
#backup_base_dir="/scratch/xv83/bxn599/backup_aus-20i_daily_monthly_separated_by_year/access-esm1-5_ssp370"
### NorESM2-MM
#base_dir="/g/data/xv83/CORDEX-CMIP6/DD/AUS-20i/CSIRO/NorESM2-MM/ssp370/r1i1p1f1/CCAM-v2203-SN/v1-r1"
#backup_base_dir="/scratch/xv83/bxn599/backup_aus-20i_daily_monthly_separated_by_year/noresm2-mm_ssp370"

# Loop through directories for daily data
for freq_dir in "$base_dir/day"; do
    find "$freq_dir" -mindepth 2 -type d | while read -r subdir; do
        ...
        # Start with years ending in '1' or '6'
        ...
        for start_year in "${start_years[@]}"; do
            ...
            backup_dir="${backup_base_dir}/day"
